...
public class BlackjackGame {
    ...
    public void initializeGame() {
        ...
        System.out.println("  -Players \"Hit\" to gain another card fromthe deck. Players \"Stay\" to keep their current card total.");
        ...
        // Ask for player names and assigns them
            ...
            if (players[i].getBet() > 0) {
                ...
                do {
                    do {
                        ...
                        System.out.println(players[i].getName() + " (H)it or (S)tand? ");
                        command = ki.next();
